...
const cacheKey = 'buttonsCacheKey';

// returns true if they were loaded, false otherwise
function tryLoadingCachedButtons() {
  const btns = localStorage.getItem(cacheKey);
  if (btns !== null) {
    window.buttons = btns;
    return true;
  } else {
