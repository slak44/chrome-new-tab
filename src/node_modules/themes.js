...
function activateTheme(theme) {
  ...
  byId('dynamic-colors').innerText = `
    ...
    .btn:hover, .btn-large:hover {background-color: ${theme.accent} !important;}
    ...
    input[type=checkbox]:not(:disabled) ~ .lever:active:before {background-color: ${theme.main}26 !important;}
  `;
}

function bindOnChange(propName, idx) {
  $(`input[name="theme-${propName}"]`).on('keyup change paste', event => {
